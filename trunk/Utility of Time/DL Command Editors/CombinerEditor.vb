...
Public Class CombinerEditor
    ...
    Private CompiledCmb As New RealCommand
    Private Sub Decode(ByVal MUXS0 As UInteger, ByVal MUXS1 As UInteger)
        ParseDL.UnpackMUX(MUXS0, MUXS1, CombinerColors)
        With CombinerColors
    ...
    Private Sub Compile()
        ...
        CompiledCmbCmd.Text = CompiledCmb.Cmd.ToString("X2") & CompiledCmb.CMDLow.ToString("X6") & CompiledCmb.CMDHigh.ToString("X8")
    End Sub
    ...
    Private Sub CompiledCmbCmd_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CompiledCmbCmd.TextChanged
        ...
        UpdateCommand(MainWin.N64DList(MainWin.DListSelection.SelectedIndex - 1), MainWin.CommandsListbox.SelectedIndex, Convert.ToByte(MainWin.CommandCodeText.Text, 16), Convert.ToUInt32(MainWin.HiwordText.Text, 16), Convert.ToUInt32(MainWin.LowordText.Text, 16))
    End Sub
    ...
    Private Sub PrimR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrimR.Click
        If ColorSelector.ShowDialog() = Windows.Forms.DialogResult.OK Then
            With LinkedCommands.PrimColor
                .CMDParams(4) = ColorSelector.Color.R
                .CMDParams(5) = ColorSelector.Color.G
                .CMDParams(6) = ColorSelector.Color.B
                .CMDParams(7) = ColorSelector.Color.A
            End With
            UpdatePrimColor(LinkedCommands.PrimColor)
        End If
    End Sub
